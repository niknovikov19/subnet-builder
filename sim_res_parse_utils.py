...
#def _get_1pop_spikes(sim_result, pop_name, combine_cells):
...
# =============================================================================
# def get_pop_spikes(sim_result, pop_name=None, combine_cells=True):
#     """Get times of spikes generated by given population(s). """
#     if pop_name is None:
#         pop_name = get_pop_names(sim_result)
#     if isinstance(pop_name, str):
#         return _get_1pop_spikes(sim_result, pop_name, combine_cells)
#     else:
#         res = {}
#         for pop in pop_name:
#             res[pop] = _get_1pop_spikes(sim_result, pop, combine_cells)
#         return res
# =============================================================================
